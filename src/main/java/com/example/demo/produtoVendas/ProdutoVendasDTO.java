...
public class ProdutoVendasDTO {
    ...
    public ProdutoVendasDTO(Long id_produto, Float quantidade, BigDecimal preco_unitario) {
    ...
    public final boolean equals(Object o) {
        if (!(o instanceof ProdutoVendasDTO that)) return false;
